...
def make_openai_query(prompt): # Mock of openai call
    response = openai.Completion.create(
        ...
        * Prompt: Rearrange the X and Y columns to go before Z
        ...
        Columns: {}
        Prompt: {}
        """.format(dataframe.columns.tolist(), prompt),
        max_tokens=60
    )
